...
//This code is for the any side

@Autonomous(name="SkyStoneAutoPrototype", group="Pushbot")
//@Disabled
public class SkyStoneAutoPrototype extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        */
        ...
        skybridge();
        moveForward(0.4, 1.15);
        turnLeft(.5, 0.9);

        moveForward(0.4, 1.30);
        turnRight(0.5, 0.45);
